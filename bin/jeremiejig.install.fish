...
set fish_path    ~/git/oh-my-fish
set config_path  ~/.config/fish
set TRAVIS_REPO_SLUG jeremiejig/oh-my-fish
set TRAVIS_BRANCH jeremiejig
...
log blue "Linking to the Oh My Fish template file"
ln -s $fish_path/templates/jeremiejig.config.fish $config_path/config.fish
